...
class WorkingPaymentFlowTester {
    constructor() {
        this.testUserId = 'working_test_user_' + Date.now();
        this.testMobileNumber = '0921234567';
        this.testPlanType = 'weekly';
        this.testAmount = 3000; // SSP amount
        this.testReference = 'WORKING_TEST_' + Date.now();
    }

    async runCompleteTest() {
        console.log('\n🚀 COMPLETE PAYMENT FLOW TEST (Working Version)');
...
module.exports = WorkingPaymentFlowTester;
